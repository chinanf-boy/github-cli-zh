...
- [x] [gh.md](src/manual/gh.zh.md)
  ...
  - [ ] [gh_auth_logout.md](src/manual/gh_auth_logout.zh.md)
  - [ ] [gh_auth_refresh.md](src/manual/gh_auth_refresh.zh.md)
  - [ ] [gh_auth_setup-git.md](src/manual/gh_auth_setup-git.zh.md)
  - [ ] [gh_auth_status.md](src/manual/gh_auth_status.zh.md)
  - [ ] [gh_browse.md](src/manual/gh_browse.zh.md)
  - [ ] [gh_codespace.md](src/manual/gh_codespace.zh.md)
  - [ ] [gh_codespace_code.md](src/manual/gh_codespace_code.zh.md)
  - [ ] [gh_codespace_cp.md](src/manual/gh_codespace_cp.zh.md)
  - [ ] [gh_codespace_create.md](src/manual/gh_codespace_create.zh.md)
  - [ ] [gh_codespace_delete.md](src/manual/gh_codespace_delete.zh.md)
  - [ ] [gh_codespace_list.md](src/manual/gh_codespace_list.zh.md)
  - [ ] [gh_codespace_logs.md](src/manual/gh_codespace_logs.zh.md)
  - [ ] [gh_codespace_ports.md](src/manual/gh_codespace_ports.zh.md)
  - [ ] [gh_codespace_ports_forward.md](src/manual/gh_codespace_ports_forward.zh.md)
  - [ ] [gh_codespace_ports_visibility.md](src/manual/gh_codespace_ports_visibility.zh.md)
  - [ ] [gh_codespace_ssh.md](src/manual/gh_codespace_ssh.zh.md)
  - [ ] [gh_codespace_stop.md](src/manual/gh_codespace_stop.zh.md)
  - [ ] [gh_completion.md](src/manual/gh_completion.zh.md)
  - [ ] [gh_config.md](src/manual/gh_config.zh.md)
  - [ ] [gh_config_get.md](src/manual/gh_config_get.zh.md)
  - [ ] [gh_config_list.md](src/manual/gh_config_list.zh.md)
  - [ ] [gh_config_set.md](src/manual/gh_config_set.zh.md)
  - [ ] [gh_extension.md](src/manual/gh_extension.zh.md)
  - [ ] [gh_extension_create.md](src/manual/gh_extension_create.zh.md)
  - [ ] [gh_extension_install.md](src/manual/gh_extension_install.zh.md)
  - [ ] [gh_extension_list.md](src/manual/gh_extension_list.zh.md)
  - [ ] [gh_extension_remove.md](src/manual/gh_extension_remove.zh.md)
  - [ ] [gh_extension_upgrade.md](src/manual/gh_extension_upgrade.zh.md)
  - [ ] [gh_gist.md](src/manual/gh_gist.zh.md)
  - [ ] [gh_gist_clone.md](src/manual/gh_gist_clone.zh.md)
  - [ ] [gh_gist_create.md](src/manual/gh_gist_create.zh.md)
  - [ ] [gh_gist_delete.md](src/manual/gh_gist_delete.zh.md)
  - [ ] [gh_gist_edit.md](src/manual/gh_gist_edit.zh.md)
  - [ ] [gh_gist_list.md](src/manual/gh_gist_list.zh.md)
  - [ ] [gh_gist_view.md](src/manual/gh_gist_view.zh.md)
